...
public class ScannerExample {
    ...
    public static void main(String[] args) {
        ...
        //0
        //enter
        //the nextDouble() takes the 2 and the 0  and puts it into the variable
        ...
        //and essentially throw it in the garbage ..21 this will leave the scanner empty so that the next time the
        // user enters data we can capture it without having left overs from the previous call
        scanner.nextLine();

        System.out.println("You entered a radius of " + x);

        double area = x * x * 3.1459;
